...
def preprocess_mixes(markers, mixes, true_proportions):
    ...
    x_train = pd.concat([scenarios_x[0],scenarios_x[1],scenarios_x[3]], axis=0)
    x_test = scenarios_x[2]
    prop_train = pd.concat([scenarios_y[0],scenarios_y[1],scenarios_y[3]], axis=0)
    prop_test = scenarios_y[2]
